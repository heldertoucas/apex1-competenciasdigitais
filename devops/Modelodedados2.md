...
| Dados de Fatura inseridos | FATURA\_INSERIDA | Os dados de uma fatura foram inseridos no sistema. |
...
### **3.A.4. Tabela: Tipos_Documento_Dossier**

**Propósito:** Catálogo dos itens que devem constar no Dossier Técnico-Pedagógico (a "Checklist").
...
### **3.A.5. Tabela: Dossier_Conformidade**

**Propósito:** Tabela de verificação (Checklist) que regista se os documentos necessários foram produzidos/existentes e onde estão guardados.
